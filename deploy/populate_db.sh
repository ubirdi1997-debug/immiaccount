...
# Copy test data file to server
scp -i /workspaces/immiaccount/deploy/vevo-app-key.pem test_data.sql ubuntu@$STATIC_IP:/home/ubuntu/

# Execute test data on server
ssh -i /workspaces/immiaccount/deploy/vevo-app-key.pem ubuntu@$STATIC_IP "sudo sqlite3 /var/www/vevo-app/database/app.db < /home/ubuntu/test_data.sql"
